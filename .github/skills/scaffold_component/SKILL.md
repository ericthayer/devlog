...
# `scaffold_component` (Global Fallback)
...
## Usage
1.  **Draft the Spec**: Run the `/sdd-workflow` and create `src/components/[ComponentName]/[ComponentName].spec.md`. Initialize the **Changelog** section.
