      ...
      <article className="max-w-6xl mx-auto px-4 md:px-12 py-12 pb-48">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <div className="brutalist-border p-8 bg-amber-300/10 space-y-8 sticky top-32 overflow-hidden flex flex-col max-h-[80vh]">
              <h4 className="font-black text-sm uppercase italic border-b-4 border-black pb-2 flex items-center gap-2 shrink-0">
              ...
              <div className="space-y-6 overflow-y-auto no-scrollbar pr-2">
                <div>
                  ...
                  <p className="text-xs font-black leading-tight uppercase underline decoration-zinc-300 underline-offset-4 break-words">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(study.seoMetadata?.keywords || []).map(k => (
                      <span key={k} className="text-[9px] bg-white border-2 border-black px-2 py-0.5 font-bold uppercase hover:bg-black hover:text-amber-300 transition-colors cursor-default">
                        {k}
                      </span>
                    ))}
                  </div>
                </div>
                {study.seoMetadata?.description && (
                   <div>
                    <span className="block mono text-[9px] font-black opacity-40 uppercase mb-2">Meta_Description</span>
              ...
              <div className="pt-4 mt-auto border-t-2 border-black/10 text-[8px] mono font-black uppercase opacity-20">
                Data_Integrity: Verified // Node_Status: Live
              </div>
            </div>
          </div>
        </div>
