...
`;
  ...
  return (
    <div className="animate-in slide-in-from-right-12 duration-500 bg-white text-black selection:bg-[#FFF500]">
      ...
      <div className="sticky top-0 bg-white border-b-4 border-black p-4 z-40 flex justify-between items-center md:px-6">
        ...
        <div className="flex gap-3">
          ...
          <BrutalistButton className="px-5 py-2 text-xs bg-[#FFF500] brutalist-shadow-sm">Publish_Final</BrutalistButton>
        </div>
      </div>
        ...
        <footer className="mt-48 pt-24 border-t-8 border-black flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <button className="flex flex-col items-center gap-2 group" onClick={handleDownloadMarkdown}>
              <BrutalistButton variant="secondary" className="w-16 h-16 !p-0 group-hover:bg-black group-hover:text-[#FFF500] transition-colors"><Icon name="FileText" size={28} /></BrutalistButton>
